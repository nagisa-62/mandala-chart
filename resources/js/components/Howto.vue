<template>
    <div>
        ...
        <div class="text">5. You can save current chart on "Save" button, and update current chart "Update Chart" button.</div>
        <div class="text">6. You can clear current all cells on "Clear This Table" button</div>
        <div class="text">7. Log in or Sign up from this button.</div>
        <div class="alert text-danger">* No.4,5 is only when you are logged in.</div>
